...
<link rel="stylesheet" href="Create.css" media="screen">
  ...
  <header class="u-black u-clearfix u-header u-sticky u-sticky-6472 u-header" id="sec-2f58"><div class="u-clearfix u-sheet u-sheet-1">
                  ...
                  <div class="u-expanded-width u-form u-form-1">
                    <form action="./handlers/upload.php" method="POST" class="u-clearfix u-form-spacing-19 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
                      ...
                      <div class="u-form-group u-form-phone u-form-group-3">
                        ...
                        <input type="text" placeholder="Embedable iframe codes" id="embedIframe" name="embedIframe" class="u-border-2 u-border-grey-10 u-grey-5 u-input u-input-rectangle u-radius-12" >

                        Organization Size: <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <input type="hidden" name="hiddenSize" id="hiddenSize"/><br>
    ...
    function smallCheck() {
            ...
            document.getElementById("hiddenSize").value = "Small";

        }

        function largeCheck() {
            document.getElementById("labelSize").innerHTML = "Large";
            document.getElementById("hiddenSize").value = "Large";
        ...
        function bothCheck() {
            ...
            document.getElementById("hiddenSize").value = "Both";
