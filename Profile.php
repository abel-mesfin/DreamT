...
$vari = getUserId();
$adminCheck1 = checkAdmin($vari)[0]['admini'];?>
<?php if(!empty($vari) ): ?>
<html>
<head>
...
<div class="notify"><span id="notifyType" class=""></span></div>
    ...
    <?php
        ...
        $accessCode = getAccessCode($user_ID)['access'];
       ...
       echo '<form action="handlers/userEditForm.php" method="POST" enctype="multipart/form-data" action="">';
        ...
        echo '<input  type="hidden" name="admin" id="admin" value="'.$user[0]['admini'].'"> ';
        ...
        if($adminCheck1 == 3 || $adminCheck1 == 4){
            echo   'Access Code: '.$accessCode.'<br>';
        }elseif ($adminCheck1 == 11 and !empty($accessCode)) {
            echo   'Access Code: '.$accessCode.'<br>';
        }
